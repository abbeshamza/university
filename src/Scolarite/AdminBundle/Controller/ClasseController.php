...
use Scolarite\AdminBundle\Entity\Classe;
use Scolarite\AdminBundle\Form\ClasseType;
...
class ClasseController extends Controller {
    ...
    public function indexAction() {
        ...
        $entities = $em->getRepository('ScolariteAdminBundle:Classe')->findAll();

        return $this->render('ScolariteAdminBundle:Classe:index.html.twig', array(
                    'entities' => $entities,
        ));
    }
    ...
    public function createAction(Request $request) {
        ...
        return $this->render('ScolariteAdminBundle:Classe:new.html.twig', array(
                    'entity' => $entity,
...
//        $form->add('submit', 'submit', array('label' => 'Create'));
    ...
    public function showAction($id) {
        ...
        $entity = $em->getRepository('ScolariteAdminBundle:Classe')->find($id);
        ...
        return $this->render('ScolariteAdminBundle:Classe:show.html.twig', array(
                    'entity' => $entity,
    ...
    public function editAction($id) {
        ...
        return $this->render('ScolariteAdminBundle:Classe:edit.html.twig', array(
                    'entity' => $entity,
