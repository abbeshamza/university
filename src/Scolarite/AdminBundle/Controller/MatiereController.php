...
use Scolarite\AdminBundle\Entity\Matiere;
use Scolarite\AdminBundle\Form\MatiereType;
...
class MatiereController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ScolariteAdminBundle:Matiere')->findAll();

        return $this->render('ScolariteAdminBundle:Matiere:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
      ...
      // display flash message
        ...
        return $this->render('ScolariteAdminBundle:Matiere:new.html.twig', array(
            'entity' => $entity,
...
//        $form->add('submit', 'submit', array('label' => 'Create'));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ScolariteAdminBundle:Matiere')->find($id);
        ...
        return $this->render('ScolariteAdminBundle:Matiere:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ScolariteAdminBundle:Matiere:edit.html.twig', array(
            'entity'      => $entity,
